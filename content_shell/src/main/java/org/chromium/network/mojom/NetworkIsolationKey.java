...
public final class NetworkIsolationKey extends Union {
  ...
  public static final NetworkIsolationKey decode(Decoder decoder0, int offset) {
    ...
    switch (dataHeader.elementsOrVersion) {
      ...
      case 1:
        ...
        result.mNonEmpty = NonEmptyNetworkIsolationKey.decode(decoder12);
        result.mTag = 1;
        break;
    }
    return result;
