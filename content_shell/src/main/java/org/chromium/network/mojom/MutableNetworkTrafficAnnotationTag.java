...
public final class MutableNetworkTrafficAnnotationTag extends Struct {
  ...
  public static MutableNetworkTrafficAnnotationTag deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static MutableNetworkTrafficAnnotationTag deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static MutableNetworkTrafficAnnotationTag decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      MutableNetworkTrafficAnnotationTag result =
          new MutableNetworkTrafficAnnotationTag(elementsOrVersion);
