...
class TlsClientSocket_Internal {
  public static final Interface.Manager<TlsClientSocket, TlsClientSocket.Proxy> MANAGER =
      new Interface.Manager<TlsClientSocket, TlsClientSocket.Proxy>() {
        @Override
        ...
        @Override
        public TlsClientSocket.Proxy buildProxy(
        ...
        switch (header.getType()) {
          case -2:
            return InterfaceControlMessagesHelper.handleRunOrClosePipe(
                TlsClientSocket_Internal.MANAGER, messageWithHeader);
          default:
            return false;
        }
        ...
        switch (header.getType()) {
          case -1:
            return InterfaceControlMessagesHelper.handleRun(
                getCore(), TlsClientSocket_Internal.MANAGER, messageWithHeader, receiver);
          default:
            return false;
        }
      } catch (DeserializationException e) {
