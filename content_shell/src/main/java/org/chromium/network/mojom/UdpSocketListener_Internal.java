...
class UdpSocketListener_Internal {
  public static final Interface.Manager<UdpSocketListener, UdpSocketListener.Proxy> MANAGER =
      new Interface.Manager<UdpSocketListener, UdpSocketListener.Proxy>() {
        @Override
        ...
        @Override
        public UdpSocketListener.Proxy buildProxy(
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements UdpSocketListener.Proxy {
    @Override
    ...
    public static UdpSocketListenerOnReceivedParams decode(Decoder decoder0) {
      ...
      try {
        ...
        UdpSocketListenerOnReceivedParams result =
            new UdpSocketListenerOnReceivedParams(elementsOrVersion);
