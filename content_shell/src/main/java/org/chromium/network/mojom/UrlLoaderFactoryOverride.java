// UrlLoaderFactoryOverride.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class UrlLoaderFactoryOverride extends org.chromium.mojo.bindings.Struct {
  ...
  public org.chromium.mojo.bindings.InterfaceRequest<UrlLoaderFactory> overriddenFactoryReceiver;
  public boolean skipCorsEnabledSchemeCheck;

  private UrlLoaderFactoryOverride(int version) {
    super(STRUCT_SIZE, version);
    this.skipCorsEnabledSchemeCheck = (boolean) false;
  }
  ...
  public static UrlLoaderFactoryOverride deserialize(org.chromium.mojo.bindings.Message message) {
   ...
   */
  public static UrlLoaderFactoryOverride deserialize(java.nio.ByteBuffer data) {
    return deserialize(
  ...
  public static UrlLoaderFactoryOverride decode(org.chromium.mojo.bindings.Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    decoder0.increaseStackDepth();
    UrlLoaderFactoryOverride result;
    try {
      org.chromium.mojo.bindings.DataHeader mainDataHeader =
          decoder0.readAndValidateDataHeader(VERSION_ARRAY);
      final int elementsOrVersion = mainDataHeader.elementsOrVersion;
      result = new UrlLoaderFactoryOverride(elementsOrVersion);
      {
        result.overridingFactory =
            decoder0.readServiceInterface(8, false, UrlLoaderFactory.MANAGER);
      }
      {
  ...
  public final void encode(org.chromium.mojo.bindings.Encoder encoder) {
    ...
    encoder0.encode(this.overriddenFactoryReceiver, 16, true);
