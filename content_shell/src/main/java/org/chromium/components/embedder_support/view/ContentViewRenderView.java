...
public class ContentViewRenderView extends FrameLayout {
  ...
  /**
   * Sets the background color of the surface view. This method is necessary because the background
   * color of ContentViewRenderView itself is covered by the background of SurfaceView.
   *
