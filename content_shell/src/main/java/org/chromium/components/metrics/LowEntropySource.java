...
public class LowEntropySource {
  ...
  /**
   * Provides access to non-identifying entropy source for FRE trials. See {@link
   * #generateLowEntropySource()} for details.
   *
   * <p>WARNING: This should only be used on first run, as otherwise the value generated by this
   * code will not correspond to what is used on the C++ side. Calling this method after FRE is
  ...
  /**
   * Should be invoked when the FRE is completed to notify LowEntropySource that {@link
   * #generateLowEntropySourceForFirstRunTrial} can no longer be used.
   */
