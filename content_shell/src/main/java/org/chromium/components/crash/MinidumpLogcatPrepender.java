...
public class MinidumpLogcatPrepender {
   ...
   *
   * <p>Target file is overwritten, not appended to the end.
   *
   ...
   *
   * @return On success, returns the file containing the combined logcat and minidump output. On
   *     failure, returns the original file containing just the minidump.
   */
  public File run() {
