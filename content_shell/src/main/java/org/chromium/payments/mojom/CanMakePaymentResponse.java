...
public final class CanMakePaymentResponse extends Struct {
  ...
  public static CanMakePaymentResponse deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static CanMakePaymentResponse deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static CanMakePaymentResponse decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      CanMakePaymentResponse result = new CanMakePaymentResponse(elementsOrVersion);
      int readInt = decoder0.readInt(8);
      result.responseType = readInt;
      CanMakePaymentEventResponseType.validate(readInt);
