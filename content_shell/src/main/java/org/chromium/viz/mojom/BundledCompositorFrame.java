...
public final class BundledCompositorFrame extends Struct {
  ...
  public static BundledCompositorFrame deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static BundledCompositorFrame deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static BundledCompositorFrame decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      BundledCompositorFrame result = new BundledCompositorFrame(elementsOrVersion);
