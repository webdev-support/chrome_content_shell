...
public final class BundledReturnedResources extends Struct {
  ...
  private BundledReturnedResources(int version) {
    super(24, version);
  }

  public BundledReturnedResources() {
    this(0);
  }

  public static BundledReturnedResources deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static BundledReturnedResources deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static BundledReturnedResources decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      BundledReturnedResources result = new BundledReturnedResources(elementsOrVersion);
