...
class CompositingModeWatcher_Internal {
  ...
  public static final Interface.Manager<CompositingModeWatcher, CompositingModeWatcher.Proxy>
      MANAGER =
          new Interface.Manager<CompositingModeWatcher, CompositingModeWatcher.Proxy>() {
            @Override
            ...
            @Override
            public CompositingModeWatcher.Proxy buildProxy(
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements CompositingModeWatcher.Proxy {
    @Override
    ...
    public void compositingModeFallbackToSoftware() {
      CompositingModeWatcherCompositingModeFallbackToSoftwareParams _message =
          new CompositingModeWatcherCompositingModeFallbackToSoftwareParams();
      getProxyHandler()
          .getMessageReceiver()
      ...
      try {
        ...
        switch (header.getType()) {
          ...
          default:
            return false;
          case 0:
            CompositingModeWatcherCompositingModeFallbackToSoftwareParams.deserialize(
  ...
  static final class CompositingModeWatcherCompositingModeFallbackToSoftwareParams extends Struct {
    ...
    public static CompositingModeWatcherCompositingModeFallbackToSoftwareParams deserialize(
        Message message) {
    ...
    public static CompositingModeWatcherCompositingModeFallbackToSoftwareParams decode(
        Decoder decoder0) {
      if (decoder0 == null) {
        return null;
      }
      ...
      try {
        ...
        CompositingModeWatcherCompositingModeFallbackToSoftwareParams result =
            new CompositingModeWatcherCompositingModeFallbackToSoftwareParams(elementsOrVersion);
        return result;
      } finally {
