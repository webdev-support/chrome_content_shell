// Vector2dF.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class Vector2dF extends org.chromium.mojo.bindings.Struct {
  ...
  public static Vector2dF deserialize(org.chromium.mojo.bindings.Message message) {
   ...
   */
  public static Vector2dF deserialize(java.nio.ByteBuffer data) {
    return deserialize(
  ...
  public static Vector2dF decode(org.chromium.mojo.bindings.Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      result = new Vector2dF(elementsOrVersion);
      {
