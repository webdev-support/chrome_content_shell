...
/**
 * A model change processor for use with a {@link PropertyObservable} model. The {@link
 * PropertyModelChangeProcessor} should be registered as a property observer of the model.
