  ...
  public static ListItem buildListMenuItem(
    ...
    PropertyModel.Builder modelBuilder =
        new PropertyModel.Builder(ListMenuItemProperties.ALL_KEYS)
            ...
            .with(ListMenuItemProperties.KEEP_START_ICON_SPACING_WHEN_HIDDEN, groupContainsIcon)
            .with(ListMenuItemProperties.TEXT_APPEARANCE_ID, R.style.TextAppearance_ListMenuItem)
            .with(
