...
public class ViewResourceInflater {
  ...
  /**
   * The callback called after inflating the View, allowing subclasses to access/modify the View
   * before it's attached to the hierarchy (if allowed) or snapshots are captured.
   */
   ...
   *
   * @return Whether the View should be attached to the hierarchy after being inflated. Subclasses
   *     should override this method to change the default behavior.
   */
  ...
  /**
   * @return Whether the View should be detached from the hierarchy after being captured. Subclasses
   *     should override this method to change the default behavior.
   */
  ...
  /**
   * @return The MeasureSpec used for calculating the width of the offscreen View. Subclasses should
   *     override this method to specify measurements. By default, this method returns an
  ...
  /**
   * @return The MeasureSpec used for calculating the height of the offscreen View. Subclasses
   *     should override this method to specify measurements. By default, this method returns an
   *     unspecified MeasureSpec.
   */
  ...
  /**
   * A custom {@link ViewTreeObserver.OnDrawListener} that invalidates the resource when the view is
   * drawn.
   */
