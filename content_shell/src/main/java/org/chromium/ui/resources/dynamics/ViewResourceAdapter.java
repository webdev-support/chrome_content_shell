...
public class ViewResourceAdapter
   ...
   * @param useHardwareBitmapDraw controls if we should software draw bitmaps or use a RenderNode
  ...
  /**
   * On every render frame, this resources will check to see if it is dirty. If so, it will take a
   * bitmap capture and push it to the renderer. Subclasses can override this method to suppress
   ...
   *
   * @param dirtyRect The region to invalidate, or {@code null} if the entire {@code Bitmap} should
   *     be redrawn.
   */
