...
public class LocalizationUtils {
   ...
   *
   * <p>Note that the locale direction can be different from layout direction. Two known cases: -
   * RTL languages on Android 4.1, due to the lack of RTL layout support on 4.1. - When user turned
   * on force RTL layout option under developer options.
   *
   * <p>Therefore, only this function should be used to query RTL for layout purposes.
   */
  @CalledByNative
   ...
   *
   * <p>This matches the directory used to store language-based assets in bundle APK splits. E.g.
   * for Hebrew, known as 'he' by Chromium, this method should return 'iw' because the .pak file
   * will be stored as /assets/locales#lang_iw/he.pak within the split.
   *
   ...
   * @return true iff the locale name matches the languages. E.g. should be false for ("fil", "fi")
   *     (Filipino locale + Finish language) but true for ("en-US", "en") (USA locale + English
   *     language).
   */
