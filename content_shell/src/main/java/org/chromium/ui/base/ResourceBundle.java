 ...
 *
 * <p>IMPORTANT: Clients that use {@link ResourceBundle} MUST call either {@link
 * ResourceBundle#setAvailablePakLocales(String[], String[])} or {@link
 * ResourceBundle#setNoAvailableLocalePaks()} before calling the getters in this class.
 */
@JNINamespace("ui")
  ...
  private static String getLocalePakResourcePath(
    ...
    if (inBundle) {
      if (locale.equals("en-US")) {
        ...
        String lang =
            LocalizationUtils.getSplitLanguageForAndroid(LocaleUtils.toBaseLanguage(locale));
