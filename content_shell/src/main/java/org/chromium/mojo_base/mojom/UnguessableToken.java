...
public final class UnguessableToken extends Struct {
  ...
  private UnguessableToken(int version) {
    super(24, version);
  }
  ...
  public static UnguessableToken deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static UnguessableToken decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      UnguessableToken result = new UnguessableToken(elementsOrVersion);
