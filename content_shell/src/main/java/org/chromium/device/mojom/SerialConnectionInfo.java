...
public final class SerialConnectionInfo extends Struct {
  ...
  public static SerialConnectionInfo deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static SerialConnectionInfo decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      SerialConnectionInfo result = new SerialConnectionInfo(elementsOrVersion);
