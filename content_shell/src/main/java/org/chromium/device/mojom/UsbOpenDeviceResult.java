...
public final class UsbOpenDeviceResult extends Union {
  ...
  public static UsbOpenDeviceResult deserialize(Message message) {
    return decode(new Decoder(message).decoderForSerializedUnion(), 0);
  }

  public static final UsbOpenDeviceResult decode(Decoder decoder0, int offset) {
    ...
    switch (dataHeader.elementsOrVersion) {
      case 0:
        ...
        UsbOpenDeviceSuccess.validate(readInt);
      ...
      case 1:
        ...
        UsbOpenDeviceError.validate(readInt2);
