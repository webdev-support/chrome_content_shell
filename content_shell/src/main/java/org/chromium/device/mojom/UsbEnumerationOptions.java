...
public final class UsbEnumerationOptions extends Struct {
  ...
  private UsbEnumerationOptions(int version) {
    super(16, version);
  }
  ...
  public static UsbEnumerationOptions deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static UsbEnumerationOptions decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      UsbEnumerationOptions result = new UsbEnumerationOptions(elementsOrVersion);
