 ...
 * blocklist was introduced to block access to YubiKeys. Without it, websites could use Web NFC to
 * read NDEF URI record in YubiKeys that includes the OTP code.
 */
public class NfcBlocklist {
  ...
  private NfcBlocklist() {
    String serverProvidedValues =
        VariationsAssociatedData.getVariationParamValue(TRIAL_NAME, HISTORICAL_BYTES_PARAM_NAME);
