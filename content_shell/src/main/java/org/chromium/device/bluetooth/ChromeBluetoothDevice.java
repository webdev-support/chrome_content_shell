...
final class ChromeBluetoothDevice {
  ...
  final HashMap<
          Wrappers.BluetoothGattCharacteristicWrapper, ChromeBluetoothRemoteGattCharacteristic>
  ...
  private ChromeBluetoothDevice(
    ...
    mWrapperToChromeCharacteristicsMap =
        new HashMap<
            Wrappers.BluetoothGattCharacteristicWrapper, ChromeBluetoothRemoteGattCharacteristic>();
    mWrapperToChromeDescriptorsMap =
        new HashMap<Wrappers.BluetoothGattDescriptorWrapper, ChromeBluetoothRemoteGattDescriptor>();
  ...
  private class BluetoothGattCallbackImpl extends Wrappers.BluetoothGattCallbackWrapper {
      ...
      if (mNativeBluetoothDeviceAndroid != 0) {
        ...
        for (Wrappers.BluetoothGattServiceWrapper service : mBluetoothGatt.getServices()) {
          ...
          String serviceInstanceId =
              getAddress() + "/" + service.getUuid().toString() + "," + service.getInstanceId();
          ChromeBluetoothDeviceJni.get()
        ...
        ChromeBluetoothDeviceJni.get()
            .onGattServicesDiscovered(mNativeBluetoothDeviceAndroid, ChromeBluetoothDevice.this);
      }
    }
    ...
    public void onCharacteristicRead(
        final Wrappers.BluetoothGattCharacteristicWrapper characteristic, final int status) {
      Wrappers.ThreadUtilsWrapper.getInstance()
          .runOnUiThread(
              () -> {
                ChromeBluetoothRemoteGattCharacteristic chromeCharacteristic =
