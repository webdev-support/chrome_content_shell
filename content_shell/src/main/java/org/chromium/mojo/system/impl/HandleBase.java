...
abstract class HandleBase implements Handle {
  ...
  /**
   * Constructor for transforming {@link HandleBase} into a specific one. It is used to transform an
   * {@link UntypedHandle} into a typed one, or any handle into an {@link UntypedHandle}.
   */
