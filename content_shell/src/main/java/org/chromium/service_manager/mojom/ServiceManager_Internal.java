...
class ServiceManager_Internal {
  ...
  public static final Interface.Manager<ServiceManager, ServiceManager.Proxy> MANAGER =
      new Interface.Manager<ServiceManager, ServiceManager.Proxy>() {
        @Override
        ...
        @Override
        public ServiceManager.Proxy buildProxy(
    ...
    public static ServiceManagerAddListenerParams decode(Decoder decoder0) {
      ...
      try {
        ...
        ServiceManagerAddListenerParams result =
            new ServiceManagerAddListenerParams(elementsOrVersion);
        result.listener =
            (ServiceManagerListener)
                decoder0.readServiceInterface(8, false, ServiceManagerListener.MANAGER);
        return result;
      } finally {
