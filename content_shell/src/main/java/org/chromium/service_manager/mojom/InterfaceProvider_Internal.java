...
class InterfaceProvider_Internal {
  ...
  public static final Interface.Manager<InterfaceProvider, InterfaceProvider.Proxy> MANAGER =
      new Interface.Manager<InterfaceProvider, InterfaceProvider.Proxy>() {
        @Override
        ...
        @Override
        public InterfaceProvider.Proxy buildProxy(
    ...
    public static InterfaceProviderGetInterfaceParams decode(Decoder decoder0) {
      ...
      try {
        ...
        InterfaceProviderGetInterfaceParams result =
            new InterfaceProviderGetInterfaceParams(elementsOrVersion);
