...
class Wrappers {
  ...
  /**
   * Extends android.content.ContextWrapper to store and retrieve the registered BroadcastReceiver.
   */
  static class WebOTPServiceContext extends ContextWrapper {
    ...
    public Intent registerReceiver(
        BroadcastReceiver receiver, IntentFilter filter, String permission, Handler handler) {
