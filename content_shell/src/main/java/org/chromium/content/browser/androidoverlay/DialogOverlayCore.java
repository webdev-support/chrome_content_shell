 ...
 * Browser UI thread.
 *
 * <p>Note that this does not implement AndroidOverlay; we just manage the android side of it. The
...
class DialogOverlayCore {
  ...
  /**
   * Release the underlying surface, and generally clean up, in response to the client releasing the
   * AndroidOverlay. This may be called more than once.
   */
  public void release() {
  ...
  /** Callbacks for finding out about the Dialog's Surface. These happen on the looper thread. */
