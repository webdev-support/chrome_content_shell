 ...
 *
 * @link
 *     https://developer.android.com/reference/android/view/accessibility/CaptioningManager.CaptioningChangeListener.html
 */
public class CaptioningChangeDelegate {
  ...
  private final HashSet<WeakReference<SystemCaptioningBridgeListener>> mListeners = new HashSet<>();
   ...
   *
   * @return the CSS-friendly String representation of the edge attribute.
   */
  ...
  public static String androidColorToCssColor(Integer color) {
    ...
    return String.format(
        "rgba(%s, %s, %s, %s)", Color.red(color), Color.green(color), Color.blue(color), alpha);
  }
