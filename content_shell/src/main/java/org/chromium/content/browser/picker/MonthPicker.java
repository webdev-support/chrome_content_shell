...
public class MonthPicker extends TwoFieldDatePicker {
  ...
  public MonthPicker(Context context, double minValue, double maxValue) {
    ...
    getPositionInYearSpinner()
        .setContentDescription(getResources().getString(R.string.accessibility_date_picker_month));
  ...
  /**
   * Tests whether the current locale is one where there are no real month names, such as Chinese,
   * Japanese, or Korean locales.
   */
