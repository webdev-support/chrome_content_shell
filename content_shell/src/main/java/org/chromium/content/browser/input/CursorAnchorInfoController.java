...
final class CursorAnchorInfoController {
  ...
  /**
   * Sets positional information of composing text as an array of character bounds or line bounding
   * boxes as an array of line bounds (or both).
   *
   ...
   * CursorAnchorInfo updates will not have this field set unless they are sent through this method.
   *
        ...
        if (compositionCharacterBounds != null) {
          ...
          for (int i = 0; i < numCharacter; ++i) {
            ...
            mCursorAnchorInfoBuilder.addCharacterBounds(
                charIndex, left, top, right, bottom, CursorAnchorInfo.FLAG_HAS_VISIBLE_REGION);
          }
        }
      }
