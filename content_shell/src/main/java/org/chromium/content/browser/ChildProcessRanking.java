...
public class ChildProcessRanking implements Iterable<ChildProcessConnection> {
  ...
  private static class RankComparator implements Comparator<ConnectionWithRank> {
    ...
    public int compare(ConnectionWithRank o1, ConnectionWithRank o2) {
      ...
      boolean o1IsVisibleMainOrImportant =
          (o1.visible && o1.frameDepth == 0) || o1.importance == ChildProcessImportance.IMPORTANT;
      boolean o2IsVisibleMainOrImportant =
          (o2.visible && o2.frameDepth == 0) || o2.importance == ChildProcessImportance.IMPORTANT;
  ...
  /**
   * Iterate from lowest to highest rank. Ranking should not be modified during iteration, including
   * using Iterator.delete.
   */
  @Override
  ...
  public void addConnection(
    ...
    mRankings.add(
        new ConnectionWithRank(connection, visible, frameDepth, intersectsViewport, importance));
  ...
  private void reposition(final int originalIndex) {
    ...
    final int right =
        atEnd ? Integer.MAX_VALUE : mRankings.get(newIndex + 1).connection.getImportanceInGroup();
