 ...
 * AudioFocusDelegate is implementingf OnAudioFocusChangeListener, making it an audio focus holder
  ...
  public void onAudioFocusChange(int focusChange) {
    ...
    switch (focusChange) {
      case AudioManager.AUDIOFOCUS_GAIN:
        if (mIsDucking) {
          AudioFocusDelegateJni.get()
              .onStopDucking(mNativeAudioFocusDelegateAndroid, AudioFocusDelegate.this);
          mIsDucking = false;
        } else {
          AudioFocusDelegateJni.get()
      ...
      case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
        mIsDucking = true;
        AudioFocusDelegateJni.get()
            .recordSessionDuck(mNativeAudioFocusDelegateAndroid, AudioFocusDelegate.this);
        AudioFocusDelegateJni.get()
