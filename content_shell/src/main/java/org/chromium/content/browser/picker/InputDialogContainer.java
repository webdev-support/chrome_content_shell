  ...
  protected void showPickerDialog(
    ...
    if (dialogType == TextInputType.DATE) {
      DatePickerDialogCompat dialog =
          new DatePickerDialogCompat(mContext, new DateListener(dialogType), year, month, monthDay);
      ...
      mDialog =
          new WeekPickerDialog(mContext, new MonthOrWeekListener(dialogType), year, week, min, max);
    }
