...
public class AccessibilityActionAndEventTracker {
  ...
  /**
   * Helper method to take an accessibility action and convert it to a string of useful information
   * for testing.
   *
   ...
   * For any events with significant info, we append this to the end of the string in square braces.
   * For example, for the TYPE_ANNOUNCEMENT events we append the announcement text.
   *
