...
/**
 * A dialog that allows the user to choose a date and time. Shown for HTML form input elements with
 * type "datetime" or "datetime-local".
 */
public class DateTimePickerDialog extends AlertDialog
  ...
  public static void onTimeChangedInternal(
      int year, int month, int day, TimePicker picker, long minTimeMillis, long maxTimeMillis) {
