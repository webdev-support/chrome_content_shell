...
public class ServicificationStartupUma {
  ...
  public static int getStartupMode(
      boolean isFullBrowserStarted, boolean isMinimalBrowserStarted, boolean startMinimalBrowser) {
  ...
  /**
   * Records the metrics of the given startup mode. If native hasn't initialized, caches the request
   * to pending commit array. Note: warm startup of Chrome doesn't record in this metrics, since it
   * doesn't go through the native initialization and has been recorded in other startup metrics.
   */
