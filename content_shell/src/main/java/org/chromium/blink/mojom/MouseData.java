...
public final class MouseData extends Struct {
  ...
  public static MouseData decode(Decoder decoder0) {
    ...
    try {
      ...
      result.clickCount = decoder0.readInt(8);
      Decoder decoder1 = decoder0.readPointer(16, true);
      result.wheelData = WheelData.decode(decoder1);
      return result;
    } finally {
  ...
  public final void encode(Encoder encoder) {
    ...
    encoder0.encode(this.clickCount, 8);
    encoder0.encode((Struct) this.wheelData, 16, true);
  }
}
