...
class ControllerServiceWorkerConnector_Internal {
  public static final Interface.Manager<
          ControllerServiceWorkerConnector, ControllerServiceWorkerConnector.Proxy>
      MANAGER =
          new Interface.Manager<
            ...
            @Override
            public ControllerServiceWorkerConnector.Proxy buildProxy(
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements ControllerServiceWorkerConnector.Proxy {
    @Override
    ...
    public void updateController(ControllerServiceWorker controller) {
      ControllerServiceWorkerConnectorUpdateControllerParams _message =
          new ControllerServiceWorkerConnectorUpdateControllerParams();
        ...
        switch (header.getType()) {
          case -2:
            return InterfaceControlMessagesHelper.handleRunOrClosePipe(
                ControllerServiceWorkerConnector_Internal.MANAGER, messageWithHeader);
          case -1:
          default:
            return false;
          case 0:
            ControllerServiceWorkerConnectorUpdateControllerParams data =
                ControllerServiceWorkerConnectorUpdateControllerParams.deserialize(
  ...
  static final class ControllerServiceWorkerConnectorUpdateControllerParams extends Struct {
    ...
    public static ControllerServiceWorkerConnectorUpdateControllerParams deserialize(
        Message message) {
    ...
    public static ControllerServiceWorkerConnectorUpdateControllerParams decode(Decoder decoder0) {
      ...
      try {
        ...
        ControllerServiceWorkerConnectorUpdateControllerParams result =
            new ControllerServiceWorkerConnectorUpdateControllerParams(elementsOrVersion);
        result.controller =
            (ControllerServiceWorker)
                decoder0.readServiceInterface(8, true, ControllerServiceWorker.MANAGER);
        return result;
      } finally {
