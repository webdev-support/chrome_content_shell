...
class AecDumpManager_Internal {
  ...
  public static final Interface.Manager<AecDumpManager, AecDumpManager.Proxy> MANAGER =
      new Interface.Manager<AecDumpManager, AecDumpManager.Proxy>() {
        @Override
        ...
        @Override
        public AecDumpManager.Proxy buildProxy(
