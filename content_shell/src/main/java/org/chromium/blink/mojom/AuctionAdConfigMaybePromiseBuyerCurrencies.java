...
public final class AuctionAdConfigMaybePromiseBuyerCurrencies extends Union {
  ...
  public void setValue(AuctionAdConfigBuyerCurrencies value) {
    this.mTag = 1;
    this.mValue = value;
  }
  ...
  public static final AuctionAdConfigMaybePromiseBuyerCurrencies decode(
      Decoder decoder0, int offset) {
    DataHeader dataHeader = decoder0.readDataHeaderForUnion(offset);
    if (dataHeader.size == 0) {
      return null;
    }
    AuctionAdConfigMaybePromiseBuyerCurrencies result =
        new AuctionAdConfigMaybePromiseBuyerCurrencies();
    switch (dataHeader.elementsOrVersion) {
      ...
      case 1:
        ...
        result.mValue = AuctionAdConfigBuyerCurrencies.decode(decoder1);
        result.mTag = 1;
        break;
    }
    return result;
