...
class RendererPreferenceWatcher_Internal {
  public static final Interface.Manager<RendererPreferenceWatcher, RendererPreferenceWatcher.Proxy>
      MANAGER =
          new Interface.Manager<RendererPreferenceWatcher, RendererPreferenceWatcher.Proxy>() {
            @Override
            ...
            @Override
            public RendererPreferenceWatcher.Proxy buildProxy(
                Core core, MessageReceiverWithResponder messageReceiver) {
              return new Proxy(core, messageReceiver);
            }

            @Override
            public Stub buildStub(Core core, RendererPreferenceWatcher impl) {
  ...
  RendererPreferenceWatcher_Internal() {}

  public static final class Proxy extends Interface.AbstractProxy
      implements RendererPreferenceWatcher.Proxy {
    @Override
    ...
    public void notifyUpdate(RendererPreferences newPrefs) {
      RendererPreferenceWatcherNotifyUpdateParams _message =
          new RendererPreferenceWatcherNotifyUpdateParams();
  ...
  public static final class Stub extends Interface.Stub<RendererPreferenceWatcher> {
        ...
        switch (header.getType()) {
          case -2:
            return InterfaceControlMessagesHelper.handleRunOrClosePipe(
                RendererPreferenceWatcher_Internal.MANAGER, messageWithHeader);
          case -1:
          default:
            return false;
          case 0:
            RendererPreferenceWatcherNotifyUpdateParams data =
                RendererPreferenceWatcherNotifyUpdateParams.deserialize(
                    messageWithHeader.getPayload());
            getImpl().notifyUpdate(data.newPrefs);
            return true;
        }
  ...
  static final class RendererPreferenceWatcherNotifyUpdateParams extends Struct {
    ...
    public static RendererPreferenceWatcherNotifyUpdateParams decode(Decoder decoder0) {
      ...
      try {
        ...
        RendererPreferenceWatcherNotifyUpdateParams result =
            new RendererPreferenceWatcherNotifyUpdateParams(elementsOrVersion);
    ...
    public final void encode(Encoder encoder) {
      ...
      encoder0.encode((Struct) this.newPrefs, 8, false);
    }
  }
}
