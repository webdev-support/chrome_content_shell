...
public final class ClipboardPermissionDescriptor extends Struct {
  ...
  public boolean willBeSanitized;
  ...
  public static ClipboardPermissionDescriptor decode(Decoder decoder0) {
    ...
    try {
      ...
      result.hasUserGesture = decoder0.readBoolean(8, 0);
      result.willBeSanitized = decoder0.readBoolean(8, 1);
      return result;
    } finally {
  ...
  public final void encode(Encoder encoder) {
    ...
    encoder0.encode(this.hasUserGesture, 8, 0);
    encoder0.encode(this.willBeSanitized, 8, 1);
  }
}
