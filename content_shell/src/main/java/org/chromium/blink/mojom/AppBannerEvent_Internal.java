...
class AppBannerEvent_Internal {
  ...
  public static final Interface.Manager<AppBannerEvent, AppBannerEvent.Proxy> MANAGER =
      new Interface.Manager<AppBannerEvent, AppBannerEvent.Proxy>() {
        @Override
        ...
        @Override
        public AppBannerEvent.Proxy buildProxy(
            Core core, MessageReceiverWithResponder messageReceiver) {
          return new Proxy(core, messageReceiver);
        }

        @Override
        public Stub buildStub(Core core, AppBannerEvent impl) {
  ...
  AppBannerEvent_Internal() {}

  public static final class Proxy extends Interface.AbstractProxy implements AppBannerEvent.Proxy {
    @Override
  ...
  public static final class Stub extends Interface.Stub<AppBannerEvent> {
    ...
    public static AppBannerEventBannerAcceptedParams decode(Decoder decoder0) {
      ...
      try {
        ...
        AppBannerEventBannerAcceptedParams result =
            new AppBannerEventBannerAcceptedParams(elementsOrVersion);
    ...
    public static AppBannerEventBannerDismissedParams decode(Decoder decoder0) {
      ...
      try {
        ...
        AppBannerEventBannerDismissedParams result =
            new AppBannerEventBannerDismissedParams(elementsOrVersion);
        return result;
      } finally {
        decoder0.decreaseStackDepth();
      }
