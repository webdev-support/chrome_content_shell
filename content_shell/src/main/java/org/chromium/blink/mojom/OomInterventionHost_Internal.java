...
class OomInterventionHost_Internal {
  public static final Interface.Manager<OomInterventionHost, OomInterventionHost.Proxy> MANAGER =
      new Interface.Manager<OomInterventionHost, OomInterventionHost.Proxy>() {
        @Override
        ...
        @Override
        public OomInterventionHost.Proxy buildProxy(
            Core core, MessageReceiverWithResponder messageReceiver) {
          return new Proxy(core, messageReceiver);
        }

        @Override
        public Stub buildStub(Core core, OomInterventionHost impl) {
  ...
  OomInterventionHost_Internal() {}

  public static final class Proxy extends Interface.AbstractProxy
      implements OomInterventionHost.Proxy {
    @Override
    ...
    public void onHighMemoryUsage() {
      OomInterventionHostOnHighMemoryUsageParams _message =
          new OomInterventionHostOnHighMemoryUsageParams();
      getProxyHandler()
          .getMessageReceiver()
  ...
  public static final class Stub extends Interface.Stub<OomInterventionHost> {
    ...
    public static OomInterventionHostOnHighMemoryUsageParams decode(Decoder decoder0) {
      ...
      try {
        ...
        OomInterventionHostOnHighMemoryUsageParams result =
            new OomInterventionHostOnHighMemoryUsageParams(elementsOrVersion);
        return result;
      } finally {
