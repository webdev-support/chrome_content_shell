...
public final class GetKeyboardLayoutMapResult extends Struct {
  ...
  public Map<String, String> layoutMap;
  public int status;
  ...
  private GetKeyboardLayoutMapResult(int version) {
    super(24, version);
  }
  ...
  public static GetKeyboardLayoutMapResult deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static GetKeyboardLayoutMapResult deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static GetKeyboardLayoutMapResult decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      GetKeyboardLayoutMapResult result = new GetKeyboardLayoutMapResult(elementsOrVersion);
      int readInt = decoder0.readInt(8);
      result.status = readInt;
      GetKeyboardLayoutMapStatus.validate(readInt);
      ...
      result.layoutMap = new HashMap();
      for (int index0 = 0; index0 < keys0.length; index0++) {
        result.layoutMap.put(keys0[index0], values0[index0]);
      }
      return result;
    } finally {
  ...
  public final void encode(Encoder encoder) {
    ...
    int size0 = this.layoutMap.size();
    String[] keys0 = new String[size0];
    String[] values0 = new String[size0];
    int index0 = 0;
    for (Map.Entry<String, String> entry0 : this.layoutMap.entrySet()) {
