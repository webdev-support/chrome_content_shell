...
public final class FontData extends Struct {
  ...
  public static FontData deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static FontData deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static FontData decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      FontData result = new FontData(elementsOrVersion);
