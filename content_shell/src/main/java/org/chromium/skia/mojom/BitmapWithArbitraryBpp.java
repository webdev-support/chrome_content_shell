...
public final class BitmapWithArbitraryBpp extends Struct {
  ...
  public static BitmapWithArbitraryBpp deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static BitmapWithArbitraryBpp deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static BitmapWithArbitraryBpp decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      BitmapWithArbitraryBpp result = new BitmapWithArbitraryBpp(elementsOrVersion);
