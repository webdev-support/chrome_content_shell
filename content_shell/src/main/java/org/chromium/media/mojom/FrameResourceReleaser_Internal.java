...
class FrameResourceReleaser_Internal {
  public static final Interface.Manager<FrameResourceReleaser, FrameResourceReleaser.Proxy>
      MANAGER =
          new Interface.Manager<FrameResourceReleaser, FrameResourceReleaser.Proxy>() {
            @Override
            ...
            @Override
            public FrameResourceReleaser.Proxy buildProxy(
                Core core, MessageReceiverWithResponder messageReceiver) {
              return new Proxy(core, messageReceiver);
            }

            @Override
            public Stub buildStub(Core core, FrameResourceReleaser impl) {
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements FrameResourceReleaser.Proxy {
    @Override
  ...
  public static final class Stub extends Interface.Stub<FrameResourceReleaser> {
    Stub(Core core, FrameResourceReleaser impl) {
      super(core, impl);
    }
