...
public final class VideoCaptureError {
  ...
  public static final int f665x5f0af558 = 54;
  ...
  public static final int f666x54da3b19 = 55;
  ...
  public static final int f667x37f7a381 = 56;
  ...
  public static final int f668x28cab2f7 = 43;
  ...
  public static final int FRAME_SINK_VIDEO_CAPTURE_DEVICE_ALREADY_ENDED_ON_FATAL_ERROR = 4;
  ...
  public static final int LACROS_VIDEO_CAPTURE_DEVICE_PROXY_ALREADY_ENDED_ON_FATAL_ERROR = 128;
  public static final int LACROS_VIDEO_CAPTURE_DEVICE_PROXY_ENCOUNTERED_FATAL_ERROR = 129;

  public static final int f669x6cfa09e9 = 112;
  ...
  public static final int SCREEN_CAPTURE_KIT_FAILED_ADD_STREAM_OUTPUT = 131;
  public static final int SCREEN_CAPTURE_KIT_FAILED_GET_SHAREABLE_CONTENT = 130;
  public static final int SCREEN_CAPTURE_KIT_FAILED_START_CAPTURE = 132;
  public static final int SCREEN_CAPTURE_KIT_FAILED_STOP_CAPTURE = 133;
  public static final int SCREEN_CAPTURE_KIT_FAILED_TO_FIND_SC_DISPLAY = 135;
  public static final int SCREEN_CAPTURE_KIT_RESET_STREAM_ERROR = 147;
  public static final int SCREEN_CAPTURE_KIT_STREAM_ERROR = 134;

  public static final int f670x6b360775 = 33;

  public static final int f671x68ee2df7 = 31;
  ...
  public static final int VIDEO_CAPTURE_CONTROLLER_INVALID = 136;

  public static final int f672xc8082bee = 1;
  public static final int VIDEO_CAPTURE_CONTROLLER_IS_ALREADY_IN_ERROR_STATE = 2;
  public static final int VIDEO_CAPTURE_CONTROLLER_UNSUPPORTED_PIXEL_FORMAT = 138;
  public static final int VIDEO_CAPTURE_DEVICE_ALREADY_RELEASED = 139;
  public static final int VIDEO_CAPTURE_DEVICE_FACTORY_CHROME_OS_CREATE_DEVICE_FAILED = 137;
  public static final int VIDEO_CAPTURE_DEVICE_FACTORY_SECOND_CREATE_DENIED = 146;
  public static final int VIDEO_CAPTURE_DEVICE_FACTORY_WIN_UNKNOWN_ERROR = 141;
  public static final int VIDEO_CAPTURE_IMPL_TIMED_OUT_ON_START = 127;
  public static final int VIDEO_CAPTURE_MANAGER_DEVICE_CONNECTION_LOST = 3;

  public static final int f673x3e54f359 = 29;
  public static final int VIDEO_CAPTURE_SYSTEM_DEVICE_ID_NOT_FOUND = 140;
  public static final int WIN_DIRECT_SHOW_CANT_GET_CAPTURE_FORMAT_SETTINGS = 77;
  public static final int WIN_DIRECT_SHOW_DEVICE_FILTER_CREATION_FAILED = 144;
  public static final int WIN_DIRECT_SHOW_DEVICE_INITIALIZATION_FAILED = 145;
  ...
  public static final int WIN_MEDIA_FOUNDATION_CAMERA_BUSY = 148;
  ...
  public static final int WIN_MEDIA_FOUNDATION_DEVICE_INITIALIZATION_FAILED = 142;
  ...
  public static final int WIN_MEDIA_FOUNDATION_SOURCE_CREATION_FAILED = 143;
  public static final int WIN_MEDIA_FOUNDATION_SYSTEM_PERMISSION_DENIED = 126;

  public @interface EnumType {}

  public static boolean isKnownValue(int value) {
    return value >= 0 && value <= 148;
  }
