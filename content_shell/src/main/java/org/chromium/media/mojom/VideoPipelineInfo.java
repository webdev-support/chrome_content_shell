...
public final class VideoPipelineInfo extends Struct {
  ...
  public static VideoPipelineInfo deserialize(Message message) {
    return decode(new Decoder(message));
  }

  public static VideoPipelineInfo deserialize(ByteBuffer data) {
    return deserialize(new Message(data, new ArrayList()));
  }

  public static VideoPipelineInfo decode(Decoder decoder0) {
    if (decoder0 == null) {
      return null;
    }
    ...
    try {
      ...
      VideoPipelineInfo result = new VideoPipelineInfo(elementsOrVersion);
