...
class MediaPlayerRendererClientExtension_Internal {
  public static final Interface.Manager<
          MediaPlayerRendererClientExtension, MediaPlayerRendererClientExtension.Proxy>
      MANAGER =
          new Interface.Manager<
            ...
            @Override
            public MediaPlayerRendererClientExtension.Proxy buildProxy(
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements MediaPlayerRendererClientExtension.Proxy {
    @Override
    ...
    public void onVideoSizeChange(Size size) {
      MediaPlayerRendererClientExtensionOnVideoSizeChangeParams _message =
          new MediaPlayerRendererClientExtensionOnVideoSizeChangeParams();
      _message.size = size;
      getProxyHandler()
          .getMessageReceiver()
    ...
    public void onDurationChange(TimeDelta duration) {
      MediaPlayerRendererClientExtensionOnDurationChangeParams _message =
          new MediaPlayerRendererClientExtensionOnDurationChangeParams();
        ...
        switch (header.getType()) {
          ...
          case 0:
            MediaPlayerRendererClientExtensionOnVideoSizeChangeParams data =
                MediaPlayerRendererClientExtensionOnVideoSizeChangeParams.deserialize(
                    messageWithHeader.getPayload());
            getImpl().onVideoSizeChange(data.size);
            return true;
          case 1:
            MediaPlayerRendererClientExtensionOnDurationChangeParams data2 =
                MediaPlayerRendererClientExtensionOnDurationChangeParams.deserialize(
                    messageWithHeader.getPayload());
  ...
  static final class MediaPlayerRendererClientExtensionOnVideoSizeChangeParams extends Struct {
    ...
    public static MediaPlayerRendererClientExtensionOnVideoSizeChangeParams deserialize(
        Message message) {
    ...
    public static MediaPlayerRendererClientExtensionOnVideoSizeChangeParams decode(
        Decoder decoder0) {
      if (decoder0 == null) {
        return null;
      }
      ...
      try {
        ...
        MediaPlayerRendererClientExtensionOnVideoSizeChangeParams result =
            new MediaPlayerRendererClientExtensionOnVideoSizeChangeParams(elementsOrVersion);
  ...
  static final class MediaPlayerRendererClientExtensionOnDurationChangeParams extends Struct {
    ...
    public static MediaPlayerRendererClientExtensionOnDurationChangeParams deserialize(
        Message message) {
      return decode(new Decoder(message));
    }
    ...
    public static MediaPlayerRendererClientExtensionOnDurationChangeParams decode(
        Decoder decoder0) {
      if (decoder0 == null) {
        return null;
      }
      ...
      try {
        ...
        MediaPlayerRendererClientExtensionOnDurationChangeParams result =
            new MediaPlayerRendererClientExtensionOnDurationChangeParams(elementsOrVersion);
        Decoder decoder1 = decoder0.readPointer(8, false);
