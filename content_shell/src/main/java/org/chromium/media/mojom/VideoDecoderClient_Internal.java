...
class VideoDecoderClient_Internal {
  ...
  public static final class Proxy extends Interface.AbstractProxy
    ...
    public void requestOverlayInfo(boolean restartForTransitions) {
      VideoDecoderClientRequestOverlayInfoParams _message =
          new VideoDecoderClientRequestOverlayInfoParams();
      ...
      try {
        ...
        switch (header.getType()) {
          ...
          case 2:
            getImpl()
                .requestOverlayInfo(
                    VideoDecoderClientRequestOverlayInfoParams.deserialize(
                            messageWithHeader.getPayload())
    ...
    public static VideoDecoderClientRequestOverlayInfoParams decode(Decoder decoder0) {
      ...
      try {
        ...
        VideoDecoderClientRequestOverlayInfoParams result =
            new VideoDecoderClientRequestOverlayInfoParams(elementsOrVersion);
