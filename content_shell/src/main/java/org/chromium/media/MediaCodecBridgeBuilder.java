...
class MediaCodecBridgeBuilder {
  ...
  static MediaCodecBridge createVideoDecoder(
    ...
    try {
      Log.i(TAG, "create MediaCodec video decoder, mime %s, decoder name %s", mime, decoderName);
      ...
      Log.e(
          TAG, "Failed to create MediaCodec video decoder: %s, codecType: %d", mime, codecType, e);
    }
