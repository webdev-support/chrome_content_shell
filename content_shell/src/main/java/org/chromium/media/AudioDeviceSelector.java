...
abstract class AudioDeviceSelector {
  ...
  /**
   * Updates the active device given the current list of devices and information about if a specific
   * device has been selected or if the default device is selected.
   */
  ...
  protected static class DeviceHelpers {
    ...
    /**
     * Use a special selection scheme if the default device is selected. The "most unique" device
     * will be selected; Wired headset first, then USB audio device, then Bluetooth and last the
     * speaker phone.
     */
  ...
  public class Devices {
    ...
    /**
     * Gets the ID of the device which should be currently selected, or ID_INVALID if no device was
     * ever requested.
     */
