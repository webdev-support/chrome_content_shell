...
public class LibraryPrefetcher {
   ...
   *
   * <p>Launches a task that, through a short-lived forked process, reads a part of each page of the
   * native library. This is done to warm up the page cache, turning hard page faults into soft
   * ones.
   *
   * <p>This is done this way, as testing shows that fadvise(FADV_WILLNEED) is detrimental to the
   * startup time.
   */
