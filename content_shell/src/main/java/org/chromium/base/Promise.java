...
public class Promise<T> {
  ...
  /**
   * An exception class for when a rejected Promise is not handled and cannot pass the rejection to
   ...
   * Callback} that throws a {@link UnhandledRejectionException}. Only use this on Promises that do
   * not have rejection handlers or dependant Promises.
   */
