...
public final class SelectionMenuItem implements Comparable<SelectionMenuItem> {
  ...
  public static class Builder {
    ...
    /**
     * Sets default values to avoid inline initialization. See
     * https://issuetracker.google.com/issues/37124982.
     */
    ...
    /**
     * Must be a {@link MenuItem} constant bit combination (i.e. MenuItem.SHOW_AS_ACTION_IF_ROOM)
     * otherwise 0.
     */
