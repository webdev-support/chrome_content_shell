...
/**
 * Class used in android:zygotePreloadName attribute of manifest. Code in this class runs in the
 * zygote. It runs in a limited environment (eg no application) and cannot communicate with any
 * other app process, so care must be taken when writing code in this class. Eg it should not create
 * any thread.
 */
