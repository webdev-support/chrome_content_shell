...
public final class ContentSwitches {
  ...
  public static final String ALLOW_LOOPBACK_IN_PEER_CONNECTION =
  ...
  public static final String AUTO_ACCEPT_CAMERA_AND_MICROPHONE_CAPTURE =
  ...
  public static final String DISABLE_BACKGROUNDING_OCCLUDED_WINDOWS_FOR_TESTING =
      "disable-backgrounding-occluded-windows";
  public static final String DISABLE_BACKGROUND_TIMER_THROTTLING =
  ...
  public static final String DISABLE_DOMAIN_BLOCKING_FOR3DAP_IS =
  ...
  public static final String DISABLE_GPU_MEMORY_BUFFER_VIDEO_FRAMES =
  ...
  public static final String DISABLE_JAVA_SCRIPT_HARMONY_SHIPPING =
  ...
  public static final String DISABLE_NEW_CONTENT_RENDERING_TIMEOUT =
  ...
  public static final String DISABLE_ORIGIN_TRIAL_CONTROLLED_BLINK_FEATURES =
  ...
  public static final String DISABLE_SITE_ISOLATION_FOR_POLICY =
  ...
  public static final String DISABLE_SOFTWARE_COMPOSITING_FALLBACK =
  ...
  public static final String ENABLE_ADAPTIVE_SELECTION_HANDLE_ORIENTATION =
      "enable-adaptive-selection-handle-orientation";
  public static final String ENABLE_AGGRESSIVE_DOM_STORAGE_FLUSHING =
  ...
  public static final String ENABLE_EXPERIMENTAL_COOKIE_FEATURES =
      "enable-experimental-cookie-features";
  public static final String ENABLE_EXPERIMENTAL_WEB_ASSEMBLY_FEATURES =
      "enable-experimental-webassembly-features";
  public static final String ENABLE_EXPERIMENTAL_WEB_PLATFORM_FEATURES =
      "enable-experimental-web-platform-features";
  public static final String ENABLE_FAKE_NO_ALLOC_DIRECT_CALL_FOR_TESTING =
      "enable-fake-no-alloc-direct-call-for-testing";
  public static final String ENABLE_GPU_MEMORY_BUFFER_VIDEO_FRAMES =
      "enable-gpu-memory-buffer-video-frames";
  public static final String ENABLE_ISOLATED_WEB_APPS_IN_RENDERER =
  ...
  public static final String ENABLE_NETWORK_INFORMATION_DOWNLINK_MAX =
      "enable-network-information-downlink-max";
  public static final String ENABLE_PLUGIN_PLACEHOLDER_TESTING =
  ...
  public static final String ENABLE_STRICT_MIXED_CONTENT_CHECKING =
      "enable-strict-mixed-content-checking";
  public static final String ENABLE_STRICT_POWERFUL_FEATURE_RESTRICTIONS =
  ...
  public static final String ENABLE_USER_MEDIA_SCREEN_CAPTURING =
  ...
  public static final String ENABLE_WEB_AUTH_DEPRECATED_MOJO_TESTING_API =
      "enable-web-auth-deprecated-mojo-testing-api";
  public static final String ENABLE_WEB_GL_DEVELOPER_EXTENSIONS =
  ...
  public static final String ENABLE_WEB_RTC_SRTP_ENCRYPTED_HEADERS =
      "enable-webrtc-srtp-encrypted-headers";
  public static final String ENFORCE_WEB_RTC_IP_PERMISSION_CHECK =
  ...
  public static final String FORCE_ONLINE_CONNECTION_STATE_FOR_INDICATOR =
      "force-online-connection-state-for-indicator";
  public static final String FORCE_PRESENTATION_RECEIVER_FOR_TESTING =
  ...
  public static final String MOCK_CERT_VERIFIER_DEFAULT_RESULT_FOR_TESTING =
  ...
  public static final String PREVENT_RESIZING_CONTENTS_FOR_TESTING =
      "prevent-resizing-contents-for-testing";
  public static final String PRIVATE_AGGREGATION_DEVELOPER_MODE =
  ...
  public static final String PROTECTED_AUDIENCES_CONSENTED_DEBUG_TOKEN =
  ...
  public static final String SHARED_ARRAY_BUFFER_UNRESTRICTED_ACCESS_ALLOWED =
  ...
  public static final String USE_FAKE_CODEC_FOR_PEER_CONNECTION =
  ...
  public static final String USE_MOCK_CERT_VERIFIER_FOR_TESTING =
  ...
  public static final String WEB_XR_RUNTIME_AR_CORE = "arcore";
  public static final String WEB_XR_RUNTIME_CARDBOARD = "cardboard";
  public static final String WEB_XR_RUNTIME_NONE = "no-xr-runtime";
