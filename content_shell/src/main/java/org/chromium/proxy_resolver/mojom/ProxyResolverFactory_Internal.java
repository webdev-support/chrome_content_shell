...
class ProxyResolverFactory_Internal {
  ...
  public static final Interface.Manager<ProxyResolverFactory, ProxyResolverFactory.Proxy> MANAGER =
      new Interface.Manager<ProxyResolverFactory, ProxyResolverFactory.Proxy>() {
        @Override
        ...
        @Override
        public ProxyResolverFactory.Proxy buildProxy(
  ...
  public static final class Proxy extends Interface.AbstractProxy
      implements ProxyResolverFactory.Proxy {
    @Override
    ...
    public void createResolver(
        String pacScript,
        InterfaceRequest<ProxyResolver> receiver,
        ProxyResolverFactoryRequestClient client) {
      ProxyResolverFactoryCreateResolverParams _message =
          new ProxyResolverFactoryCreateResolverParams();
        ...
        switch (header.getType()) {
          ...
          case 0:
            ProxyResolverFactoryCreateResolverParams data =
                ProxyResolverFactoryCreateResolverParams.deserialize(
    ...
    public static ProxyResolverFactoryCreateResolverParams decode(Decoder decoder0) {
      ...
      try {
        ...
        ProxyResolverFactoryCreateResolverParams result =
            new ProxyResolverFactoryCreateResolverParams(elementsOrVersion);
        ...
        result.client =
            (ProxyResolverFactoryRequestClient)
                decoder0.readServiceInterface(20, false, ProxyResolverFactoryRequestClient.MANAGER);
        return result;
      } finally {
