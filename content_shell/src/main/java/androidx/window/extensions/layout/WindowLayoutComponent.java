...
public interface WindowLayoutComponent {
  /**
   * @deprecated Use {@link #addWindowLayoutInfoListener(Context, Consumer)} starting with {@link
   *     WindowExtensions#VENDOR_API_LEVEL_2}. Only used if {@link
   *     #addWindowLayoutInfoListener(Context, Consumer)} can't be called on {@link
   *     WindowExtensions#VENDOR_API_LEVEL_1}. Since {@link WindowExtensions#VENDOR_API_LEVEL_1}
   */
  @Deprecated
  void addWindowLayoutInfoListener(
      @NonNull Activity activity, @NonNull java.util.function.Consumer<WindowLayoutInfo> consumer);

  /**
   * @deprecated Use {@link #removeWindowLayoutInfoListener(Consumer)} starting with {@link
   *     WindowExtensions#VENDOR_API_LEVEL_2}. Only used if {@link
   *     #removeWindowLayoutInfoListener(Consumer)} can't be called on {@link
   *     WindowExtensions#VENDOR_API_LEVEL_1}. Since {@link WindowExtensions#VENDOR_API_LEVEL_1}
   */
  @Deprecated
   ...
   * @param consumer interested in receiving updates to {@link WindowLayoutInfo} Since {@link
  ...
  default void addWindowLayoutInfoListener(
      @NonNull @UiContext Context context, @NonNull Consumer<WindowLayoutInfo> consumer) {
   ...
   *
   * @param consumer no longer interested in receiving updates to {@link WindowLayoutInfo} Since
