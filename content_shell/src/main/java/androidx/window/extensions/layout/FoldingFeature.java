...
public class FoldingFeature implements DisplayFeature {
  ...
  /**
   * The foldable device's hinge is completely open, the screen space that is presented to the user
   * is flat. See the <a
   * href="https://developer.android.com/guide/topics/ui/foldables#postures">Posture</a> section in
   * the official documentation for visual samples and references.
   */
