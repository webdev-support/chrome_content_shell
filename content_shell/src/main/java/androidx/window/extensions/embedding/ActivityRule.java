...
public class ActivityRule extends EmbeddingRule {
  ...
  public static final class Builder {
     ...
     *     rule Since {@link WindowExtensions#VENDOR_API_LEVEL_2}
     */
    public Builder(
        @NonNull Predicate<Activity> activityPredicate,
        @NonNull Predicate<Intent> intentPredicate) {
    ...
    /**
     * @see ActivityRule#getTag() Since {@link
  ...
  public String toString() {
    return "ActivityRule{mTag=" + getTag() + "mShouldAlwaysExpand=" + mShouldAlwaysExpand + '}';
  }
}
