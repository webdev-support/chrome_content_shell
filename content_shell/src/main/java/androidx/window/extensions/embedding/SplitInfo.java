...
public class SplitInfo {
  ...
  @NonNull private final ActivityStack mPrimaryActivityStack;
  @NonNull private final ActivityStack mSecondaryActivityStack;
  @NonNull private final SplitAttributes mSplitAttributes;
   ...
   * @param token The token to identify this split pair Since {@link
  ...
  /**
   * @deprecated Use the {@link WindowExtensions#VENDOR_API_LEVEL_3} version. Since {@link
  ...
  SplitInfo(
      ...
      @NonNull ActivityStack secondaryActivityStack,
      @NonNull SplitAttributes splitAttributes) {
    this(primaryActivityStack, secondaryActivityStack, splitAttributes, INVALID_SPLIT_INFO_TOKEN);
  }
  ...
  /**
   * @deprecated Use {@link #getSplitAttributes()} starting with {@link
   *     WindowExtensions#VENDOR_API_LEVEL_2}. Only used if {@link #getSplitAttributes()} can't be
  ...
  /**
   * Returns the {@link SplitAttributes} of this split. Since {@link
  ...
  /**
   * Returns a token uniquely identifying the container. Since {@link
   * WindowExtensions#VENDOR_API_LEVEL_3}
   */
  @NonNull
