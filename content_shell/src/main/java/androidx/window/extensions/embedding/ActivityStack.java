...
public class ActivityStack {
  ...
  @NonNull private final List<Activity> mActivities;
   ...
   *     ActivityStack}
   * @param token The token to identify this {@code ActivityStack} Since {@link
   ...
   * ActivityStack. That said, if this ActivityStack only contains activities from another process,
   * {@link #getActivities()} will return empty list, while this method will return {@code false}.
   */
