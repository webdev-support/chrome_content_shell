...
public abstract class SplitRule extends EmbeddingRule {
  ...
  @NonNull private final SplitAttributes mDefaultSplitAttributes;
   ...
   * finished if it's shown adjacent to the secondary container. The primary associated container is
   * not finished if it occupies entire task bounds.
   *
  ...
  /**
   * @deprecated Use {@link #getDefaultSplitAttributes()} instead starting with {@link
   *     WindowExtensions#VENDOR_API_LEVEL_2}. Only used if {@link #getDefaultSplitAttributes()}
