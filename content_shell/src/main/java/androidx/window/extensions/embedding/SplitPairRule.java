...
public class SplitPairRule extends SplitRule {
  @NonNull private final Predicate<Pair<Activity, Activity>> mActivityPairPredicate;
  @NonNull private final Predicate<Pair<Activity, Intent>> mActivityIntentPredicate;
  ...
  public static final class Builder {
    ...
    /**
     * @deprecated Use {@link #Builder(Predicate, Predicate, Predicate)} starting with {@link
     *     WindowExtensions#VENDOR_API_LEVEL_2}. Only used if {@link #Builder(Predicate, Predicate,
     *     Predicate)} can't be called on {@link WindowExtensions#VENDOR_API_LEVEL_1}.
     */
    @Deprecated
    @RequiresApi(Build.VERSION_CODES.N)
    public Builder(
        @NonNull java.util.function.Predicate<Pair<Activity, Activity>> activityPairPredicate,
        @NonNull java.util.function.Predicate<Pair<Activity, Intent>> activityIntentPredicate,
     ...
     * @param parentWindowMetricsPredicate the {@link Predicate} to verify if the matched split pair
     *     is allowed to show adjacent to each other with the given parent {@link WindowMetrics}
     ...
     *     WindowExtensions#VENDOR_API_LEVEL_1}. {@code splitRatio} will be translated to {@link
    ...
    /**
     * See {@link SplitPairRule#getDefaultSplitAttributes()} for reference. Overrides values if set
     * in {@link #setSplitRatio(float)} and {@link #setLayoutDirection(int)}
     *
    ...
    /**
     * @see SplitPairRule#getTag() Since {@link WindowExtensions#VENDOR_API_LEVEL_2}
     */
    @NonNull
