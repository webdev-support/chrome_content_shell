 ...
 *
 * @see ActivityEmbeddingComponent#clearSplitAttributesCalculator() Since {@link
 *     androidx.window.extensions.WindowExtensions#VENDOR_API_LEVEL_2}
 */
public class SplitAttributesCalculatorParams {
  @NonNull private final WindowMetrics mParentWindowMetrics;
  @NonNull private final Configuration mParentConfiguration;
  @NonNull private final WindowLayoutInfo mParentWindowLayoutInfo;
  @NonNull private final SplitAttributes mDefaultSplitAttributes;
  private final boolean mAreDefaultConstraintsSatisfied;
  @Nullable private final String mSplitRuleTag;
  ...
  public String toString() {
    return getClass().getSimpleName()
        + ":{"
        + "windowMetrics="
        + windowMetricsToString(mParentWindowMetrics)
        + ", configuration="
