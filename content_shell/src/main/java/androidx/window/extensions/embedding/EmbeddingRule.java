...
public abstract class EmbeddingRule {
   ...
   * in the corresponding rule builder to be able to differentiate between different rules in {@link
   * SplitAttributes} calculator function. For example, it can be used to compute the {@link
   * SplitAttributes} for the specific {@link SplitRule} in the {@link Function} set with {@link
   * ActivityEmbeddingComponent#setSplitAttributesCalculator(Function)}.
   *
   * <p>Since {@link androidx.window.extensions.WindowExtensions#VENDOR_API_LEVEL_2}
   */
  @Nullable
